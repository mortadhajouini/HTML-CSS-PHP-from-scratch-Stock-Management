...
function supprimer() {
    ...
    if(!radioBtn){
        window.location.href="listeproderr.php";
    }
    else{
    document.getElementById("f").action = "supp.php";
...
function modifier() {
    ...
    document.getElementById("f").action = "update.php";
    document.getElementById("f").submit();}
}
</script>
</head>
                ...
                <?php include ("connexion.php"); 
                    ...
                    while ($row = $stmt->fetch_assoc()){
                        ...
                        echo"<td style='border: 2px solid #636363; width:15px;' colspan='2'>
                                ...
                                <input type='radio'name='rad'id='r'value='".$row["sn"]."'>
